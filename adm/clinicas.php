...
if (isset($_POST['Pesquisar'])){$Pesquisar = $_POST['Pesquisar'];}
     ...
     if ($Incluir){
		 $inclu= "insert into clinicas (id,nome,razao,doc,endereco,cidade,estado,cep,telefone,contato,tel_contato,sit,logo) values (0,'$t_nome','$t_razao','$t_doc','$t_endereco','$t_cidade','$t_estado','$t_cep','$t_tel','$t_contato','$t_contatotel','$t_sit','$t_logo')";
     ...
     if ($Excluir){
		 $inclu= "delete from clinicas where id = ". $t_id;
		 mysqli_query($con, $inclu);
         $t_id  = "";
	 }
...
<BR />
  ...
  <input type="submit" name="Pesquisar" id="Pesquisar" value="Pesquisar" onclick="return popserv('clinicas')"/>
</form>
