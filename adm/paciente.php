...
if (isset($_POST['Pesquisar'])){$Pesquisar = $_POST['Pesquisar'];}
     ...
     if ($t_id){
         $result=mysqli_query($con, 'SELECT * from pacientes where idClinica = '.$t_idClinica.' and id = '.$t_id);    
...
<form id="form1" name="form1" method="post" action="">
 ...
 <input type="submit" name="Pesquisar" id="Pesquisar" value="Pesquisar" onclick="return popserv('pacientes', <? echo $t_idClinica; ?>)"/>
</p>
</form>
